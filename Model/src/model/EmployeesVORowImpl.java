...
public class EmployeesVORowImpl extends ViewRowImpl {
    ...
    public static final int EMPIMAGE = AttributesEnum.EmpImage.index();
    ...
    /**
     * Gets the attribute value for EMP_IMAGE using the alias name EmpImage.
     * @return the EMP_IMAGE
     */
    public BlobDomain getEmpImage() {
        return (BlobDomain) getAttributeInternal(EMPIMAGE);
    }

    /**
     * Sets <code>value</code> as attribute value for EMP_IMAGE using the alias name EmpImage.
     * @param value value to set the EMP_IMAGE
     */
    public void setEmpImage(BlobDomain value) {
        setAttributeInternal(EMPIMAGE, value);
    }
    ...
    public BigDecimal getState() {
        return (BigDecimal) getAttributeInternal(STATE);
    }
